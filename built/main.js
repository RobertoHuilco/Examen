...
function addVendedor() {
    ...
    document.write("Su cédula es: " + currentVendedor.dni, "  Su nombre es: " + currentVendedor.fullName, "  La seccion de la poblacion al que el vende es: " + currentVendedor.seccion, "  Su celular es: " + currentVendedor.celular);
}
function addClient() {
    let currentClient = {
    ...
    document.write("Su cédula es: " + currentClient.dni, "  Su nombre es: " + currentClient.fullName, "  Su dirección es: " + currentClient.direccion, "  Su edad es: " + currentClient.edad);
}
function readFromHtml(id) {
    return document.getElementById(id).value;
}
function initSelect() {
    let vendedor_area = document.getElementById("vendedor_area");
